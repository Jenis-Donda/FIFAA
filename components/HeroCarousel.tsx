          ...
          <div className="bg-[#0d3a5c] flex-shrink-0">
            <div className="flex items-stretch">
              ...
              <button
                onClick={navPrev}
                disabled={!canNavPrev}
                className={`w-12 sm:w-14 lg:w-16 flex-shrink-0 flex items-center justify-center transition-colors border-r border-white/10 ${
                  canNavPrev
                  ...
                  return (
                    <button
                      ...
                      className={`flex-1 text-left px-4 sm:px-5 lg:px-6 py-5 sm:py-6 transition-all duration-300 relative border-r border-white/10 last:border-r-0 ${
                        isActive ? "bg-[#1a5694]" : "hover:bg-white/5"
                      }`}
                    >
                      {/* Eyebrow */}
                      <p
                        className={`text-[10px] sm:text-xs font-medium mb-1.5 transition-colors truncate ${
              ...
              <button
                onClick={navNext}
                disabled={!canNavNext}
                className={`w-12 sm:w-14 lg:w-16 flex-shrink-0 flex items-center justify-center transition-colors border-l border-white/10 ${
                  canNavNext
                    ? "text-white/70 hover:text-white hover:bg-white/10 cursor-pointer"
                    : "text-white/30 cursor-not-allowed"
                }`}
